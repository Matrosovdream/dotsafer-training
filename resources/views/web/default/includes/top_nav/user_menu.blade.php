@if( empty($authUser))
    ...
    <a href="/login" class="btn lg:flex hidden has-text btn--contained btn--base btn--middle">{{ trans('auth.login') }}</a>
...
<div class="custom-dropdown navbar-auth-user-dropdown position-relative">
        <div class="custom-dropdown-toggle d-flex align-items-center navbar-user cursor-pointer">
            <span class="btn lg:flex hidden has-text btn--contained btn--base btn--middle">{{ $authUser->full_name }}</span>
        </div>
